...
namespace WindowsFormsApp17
{
    public partial class Form1 : Form
    {
        ...
        {
            FileStream olo = new FileStream("C:/Users/Ученик/Desktop/Новая папка (4)/login and pasvord", FileMode.OpenOrCreate);
            StreamWriter writer = new StreamWriter(olo);
            FileStream popo = new FileStream("C:/Users/Ученик/Desktop/Новая папка (4)/frendlist", FileMode.OpenOrCreate);
            StreamWriter writ = new StreamWriter(popo);
            olo.Seek(0,SeekOrigin.End);
            writer.WriteLine(textBox3.Text);
            writ.WriteLine(textBox3.Text);
        ...
        {
            FileStream popo = new FileStream("C:/Users/Ученик/Desktop/Новая папка (4)/frendlist", FileMode.OpenOrCreate);
            StreamReader reader = new StreamReader(popo);
            while (!reader.EndOfStream)
            {
